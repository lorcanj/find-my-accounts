...
var require_composeK = __commonJS({
  "node_modules/ramda/src/composeK.js"(exports, module) {
...
var require_pipeP = __commonJS({
  "node_modules/ramda/src/internal/_pipeP.js"(exports, module) {
    function _pipeP(f, g) {
      return function() {
        var ctx = this;
...
var require_pipeP2 = __commonJS({
  "node_modules/ramda/src/pipeP.js"(exports, module) {
    var _arity = require_arity();
...
var require_composeP = __commonJS({
  "node_modules/ramda/src/composeP.js"(exports, module) {
...
var require_contains = __commonJS({
  "node_modules/ramda/src/contains.js"(exports, module) {
    var _includes = require_includes();
    var _curry2 = require_curry2();
...
var require_merge = __commonJS({
  "node_modules/ramda/src/merge.js"(exports, module) {
    var _objectAssign = require_objectAssign();
    var _curry2 = require_curry2();
...
var require_pipeK = __commonJS({
  "node_modules/ramda/src/pipeK.js"(exports, module) {
...
var require_then = __commonJS({
  "node_modules/ramda/src/then.js"(exports, module) {
    var _curry2 = require_curry2();
    var _assertPromise = require_assertPromise();
...
var require_src = __commonJS({
  "node_modules/ramda/src/index.js"(exports, module) {
    ...
    module.exports.then = require_then();
...
var require_timezones = __commonJS({
  "node_modules/emailjs-mime-parser/dist/timezones.js"(exports) {
    "use strict";
...
var require_base64_decode = __commonJS({
  "node_modules/emailjs-base64/dist/base64-decode.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var arr2str = function arr2str2(arr) {
      return String.fromCharCode.apply(null, arr);
    };
    exports.default = function(base64Str) {
      var outputEncoding = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : OUTPUT_STRING;
...
var require_base64_encode = __commonJS({
  "node_modules/emailjs-base64/dist/base64-encode.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var tripletToBase64 = function tripletToBase642(num) {
    ...
    var str2arr = function str2arr2(str) {
    ...
    function encode(data) {
      ...
      if (extraBytes === 1) {
        ...
        output += LOOKUP[_tmp >> 4 & 63];
        output += LOOKUP[_tmp << 2 & 63];
        output += "=";
      }
      return output;
    }
...
var require_base64 = __commonJS({
  "node_modules/emailjs-base64/dist/base64.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var _base64Decode = require_base64_decode();
    ...
    var _base64Encode = require_base64_encode();
...
var require_charset = __commonJS({
  "node_modules/emailjs-mime-codec/dist/charset.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    exports.convert = exports.arr2str = exports.encode = void 0;
    exports.decode = decode;
    var _textEncoding = require_text_encoding();
    var encode = exports.encode = function encode2(str) {
      return new _textEncoding.TextEncoder("UTF-8").encode(str);
    };
    var arr2str = exports.arr2str = function arr2str2(arr) {
      var CHUNK_SZ = 32768;
      var strs = [];
    ...
    function decode(buf) {
      var fromCharset = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "utf-8";
      ...
      try {
        for (var _iterator = charsets[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var _step$value = _step.value, charset = _step$value.charset, fatal = _step$value.fatal;
          try {
            return new _textEncoding.TextDecoder(charset, { fatal }).decode(buf);
          } catch (e) {
          }
        }
      } catch (err) {
    ...
    var convert = exports.convert = function convert2(data, fromCharset) {
      return typeof data === "string" ? encode(data) : encode(decode(data, fromCharset));
    };
    function normalizeCharset() {
      var charset = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "utf-8";
      var match = void 0;
...
var require_mimecodec = __commonJS({
  "node_modules/emailjs-mime-codec/dist/mimecodec.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    exports.convert = exports.encode = exports.decode = void 0;
    ...
    var _emailjsBase = require_base64();
    var _charset = require_charset();
    ...
    function mimeEncode() {
      ...
      return buffer.reduce(function(aggregate, ord, index) {
        return _checkRanges(ord) && !((ord === 32 || ord === 9) && (index === buffer.length - 1 || buffer[index + 1] === 10 || buffer[index + 1] === 13)) ? aggregate + String.fromCharCode(ord) : aggregate + "=" + (ord < 16 ? "0" : "") + ord.toString(16).toUpperCase();
      }, "");
    ...
    function quotedPrintableEncode() {
      ...
      return _addQPSoftLinebreaks(mimeEncodedStr);
    }
    function quotedPrintableDecode() {
      var str = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "";
      var fromCharset = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "UTF-8";
      var rawString = str.replace(/[\t ]+$/gm, "").replace(/=(?:\r?\n|$)/g, "");
      return mimeDecode(rawString, fromCharset);
    }
    function mimeWordEncode(data) {
      var mimeWordEncoding = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "Q";
      var fromCharset = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : "UTF-8";
      var parts = [];
    ...
    var qEncodeForbiddenHeaderChars = function qEncodeForbiddenHeaderChars2(str) {
      var qEncode = function qEncode2(chr) {
        return chr === " " ? "_" : "=" + (chr.charCodeAt(0) < 16 ? "0" : "") + chr.charCodeAt(0).toString(16).toUpperCase();
      };
    ...
    function headerLineDecode() {
      var headerLine = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "";
    ...
    function _splitMimeEncodedString(str) {
      ...
      while (str.length) {
        ...
        while (!done) {
          ...
          var _match = str.substr(curLine.length).match(/^=([0-9A-F]{2})/i);
          if (_match) {
    ...
    function _addBase64SoftLinebreaks() {
      var base64EncodedStr = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "";
      return base64EncodedStr.trim().replace(new RegExp(".{" + MAX_LINE_LENGTH + "}", "g"), "$&\r\n").trim();
    }
    function _addQPSoftLinebreaks() {
      var qpEncodedStr = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "";
      var pos = 0;
      var len = qpEncodedStr.length;
      var lineMargin = Math.floor(MAX_LINE_LENGTH / 3);
      var result = "";
      var match = void 0, line = void 0;
      while (pos < len) {
...
var require_addressparser = __commonJS({
  "node_modules/emailjs-addressparser/dist/addressparser.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    function _handleAddress(tokens) {
      ...
      if (isGroup) {
        ...
        if (!data.address.length && data.text.length) {
          ...
          var _regexHandler = function _regexHandler2(address2) {
...
var require_mimeparser = __commonJS({
  "node_modules/emailjs-mime-parser/dist/mimeparser.js"(exports) {
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    exports.MimeNode = exports.NodeCounter = void 0;
    var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function(obj) {
      return typeof obj;
    } : function(obj) {
      return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj;
    ...
    exports.default = parse;
    var _ramda = require_src();
    var _timezones = require_timezones();
    var _timezones2 = _interopRequireDefault(_timezones);
    var _emailjsMimeCodec = require_mimecodec();
    var _textEncoding = require_text_encoding();
    var _emailjsAddressparser = require_addressparser();
    ...
    var NodeCounter = exports.NodeCounter = (function() {
      function NodeCounter2() {
        _classCallCheck(this, NodeCounter2);
        this.count = 0;
      }
      _createClass(NodeCounter2, [{
        key: "bump",
        value: function bump() {
    ...
    var MimeNode = exports.MimeNode = (function() {
      function MimeNode2() {
        var nodeCounter = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : new NodeCounter();
        _classCallCheck(this, MimeNode2);
      ...
      _createClass(MimeNode2, [{
        ...
        value: function _decodeHeaderCharset(parsed) {
          var _this2 = this;
          var _ref = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, isAddress = _ref.isAddress;
        ...
        value: function fetchContentType() {
          ...
          if (this.contentType.value === "message/rfc822" && !isAttachment) {
            this._currentChild = new MimeNode2(this.nodeCounter);
        ...
        */
        ...
        value: function detectHTMLCharset(html) {
          var charset = void 0, input = void 0;
          html = html.replace(/\r?\n|\r/g, " ");
    ...
    var utf8Str2arr = function utf8Str2arr2(str) {
      return new _textEncoding.TextEncoder("utf-8").encode(str);
    };
  }
});
export default require_mimeparser();
